...
export const blerpc = $root.blerpc = (() => {
    ...
    blerpc.EchoRequest = (function() {
        ...
        EchoRequest.decode = function decode(reader, length, error, long) {
            ...
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.blerpc.EchoRequest();
        ...
        EchoRequest.fromObject = function fromObject(object, long) {
            ...
            if (!$util.isObject(object))
                throw TypeError(".blerpc.EchoRequest: object expected");
            if (long === undefined)
                long = 0;
            if (long > $util.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            let message = new $root.blerpc.EchoRequest();
    ...
    blerpc.EchoResponse = (function() {
        ...
        EchoResponse.decode = function decode(reader, length, error, long) {
            ...
            if (long > $Reader.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.blerpc.EchoResponse();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        EchoResponse.fromObject = function fromObject(object, long) {
            if (object instanceof $root.blerpc.EchoResponse)
                return object;
            if (!$util.isObject(object))
                throw TypeError(".blerpc.EchoResponse: object expected");
            if (long === undefined)
                long = 0;
            if (long > $util.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            let message = new $root.blerpc.EchoResponse();
            if (object.message != null)
                message.message = String(object.message);
            return message;
        };
    ...
    blerpc.FlashReadRequest = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        FlashReadRequest.encode = function encode(message, writer, q) {
            if (!writer)
                writer = $Writer.create();
            if (q === undefined)
                q = 0;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        FlashReadRequest.decode = function decode(reader, length, error, long) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            if (long === undefined)
                long = 0;
            if (long > $Reader.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.blerpc.FlashReadRequest();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        FlashReadRequest.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
         ...
         * @returns {blerpc.FlashReadRequest} FlashReadRequest
         */
        FlashReadRequest.fromObject = function fromObject(object, long) {
            if (object instanceof $root.blerpc.FlashReadRequest)
                return object;
            if (!$util.isObject(object))
                throw TypeError(".blerpc.FlashReadRequest: object expected");
            if (long === undefined)
                long = 0;
            if (long > $util.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            let message = new $root.blerpc.FlashReadRequest();
         ...
         * @returns {Object.<string,*>} Plain object
         */
        FlashReadRequest.toObject = function toObject(message, options, q) {
            if (!options)
                options = {};
            if (q === undefined)
                q = 0;
    ...
    blerpc.FlashReadResponse = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        FlashReadResponse.encode = function encode(message, writer, q) {
            if (!writer)
                writer = $Writer.create();
            if (q === undefined)
                q = 0;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        FlashReadResponse.decode = function decode(reader, length, error, long) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            if (long === undefined)
                long = 0;
            if (long > $Reader.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.blerpc.FlashReadResponse();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        FlashReadResponse.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
         ...
         * @returns {blerpc.FlashReadResponse} FlashReadResponse
         */
        FlashReadResponse.fromObject = function fromObject(object, long) {
            if (object instanceof $root.blerpc.FlashReadResponse)
                return object;
            if (!$util.isObject(object))
                throw TypeError(".blerpc.FlashReadResponse: object expected");
            if (long === undefined)
                long = 0;
            if (long > $util.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            let message = new $root.blerpc.FlashReadResponse();
            if (object.address != null)
                message.address = object.address >>> 0;
            if (object.data != null)
         ...
         * @returns {Object.<string,*>} Plain object
         */
        FlashReadResponse.toObject = function toObject(message, options, q) {
            if (!options)
                options = {};
            if (q === undefined)
                q = 0;
    ...
    blerpc.DataWriteRequest = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        DataWriteRequest.encode = function encode(message, writer, q) {
            if (!writer)
                writer = $Writer.create();
            if (q === undefined)
                q = 0;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        DataWriteRequest.decode = function decode(reader, length, error, long) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            if (long === undefined)
                long = 0;
            if (long > $Reader.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.blerpc.DataWriteRequest();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        DataWriteRequest.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
         ...
         * @returns {blerpc.DataWriteRequest} DataWriteRequest
         */
        DataWriteRequest.fromObject = function fromObject(object, long) {
            if (object instanceof $root.blerpc.DataWriteRequest)
                return object;
            if (!$util.isObject(object))
                throw TypeError(".blerpc.DataWriteRequest: object expected");
            if (long === undefined)
                long = 0;
            if (long > $util.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            let message = new $root.blerpc.DataWriteRequest();
            if (object.data != null)
                if (typeof object.data === "string")
                    $util.base64.decode(object.data, message.data = $util.newBuffer($util.base64.length(object.data)), 0);
                else if (object.data.length >= 0)
         ...
         * @returns {Object.<string,*>} Plain object
         */
        DataWriteRequest.toObject = function toObject(message, options, q) {
            if (!options)
                options = {};
            if (q === undefined)
                q = 0;
    ...
    blerpc.DataWriteResponse = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        DataWriteResponse.encode = function encode(message, writer, q) {
            if (!writer)
                writer = $Writer.create();
            if (q === undefined)
                q = 0;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        DataWriteResponse.decode = function decode(reader, length, error, long) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            if (long === undefined)
                long = 0;
            if (long > $Reader.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.blerpc.DataWriteResponse();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        DataWriteResponse.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
         ...
         * @returns {blerpc.DataWriteResponse} DataWriteResponse
         */
        DataWriteResponse.fromObject = function fromObject(object, long) {
            if (object instanceof $root.blerpc.DataWriteResponse)
                return object;
            if (!$util.isObject(object))
                throw TypeError(".blerpc.DataWriteResponse: object expected");
            if (long === undefined)
                long = 0;
            if (long > $util.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            let message = new $root.blerpc.DataWriteResponse();
            if (object.length != null)
                message.length = object.length >>> 0;
            return message;
        };
         ...
         * @returns {Object.<string,*>} Plain object
         */
        DataWriteResponse.toObject = function toObject(message, options, q) {
            if (!options)
                options = {};
            if (q === undefined)
                q = 0;
    ...
    blerpc.CounterStreamRequest = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        CounterStreamRequest.encode = function encode(message, writer, q) {
            if (!writer)
                writer = $Writer.create();
            if (q === undefined)
                q = 0;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CounterStreamRequest.decode = function decode(reader, length, error, long) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            if (long === undefined)
                long = 0;
            if (long > $Reader.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.blerpc.CounterStreamRequest();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        CounterStreamRequest.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
         ...
         * @returns {blerpc.CounterStreamRequest} CounterStreamRequest
         */
        CounterStreamRequest.fromObject = function fromObject(object, long) {
            if (object instanceof $root.blerpc.CounterStreamRequest)
                return object;
            if (!$util.isObject(object))
                throw TypeError(".blerpc.CounterStreamRequest: object expected");
            if (long === undefined)
                long = 0;
            if (long > $util.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            let message = new $root.blerpc.CounterStreamRequest();
         ...
         * @returns {Object.<string,*>} Plain object
         */
        CounterStreamRequest.toObject = function toObject(message, options, q) {
            if (!options)
                options = {};
            if (q === undefined)
                q = 0;
    ...
    blerpc.CounterStreamResponse = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        CounterStreamResponse.encode = function encode(message, writer, q) {
            if (!writer)
                writer = $Writer.create();
            if (q === undefined)
                q = 0;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CounterStreamResponse.decode = function decode(reader, length, error, long) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            if (long === undefined)
                long = 0;
            if (long > $Reader.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.blerpc.CounterStreamResponse();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        CounterStreamResponse.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
         ...
         * @returns {blerpc.CounterStreamResponse} CounterStreamResponse
         */
        CounterStreamResponse.fromObject = function fromObject(object, long) {
            if (object instanceof $root.blerpc.CounterStreamResponse)
                return object;
            if (!$util.isObject(object))
                throw TypeError(".blerpc.CounterStreamResponse: object expected");
            if (long === undefined)
                long = 0;
            if (long > $util.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            let message = new $root.blerpc.CounterStreamResponse();
            if (object.seq != null)
         ...
         * @returns {Object.<string,*>} Plain object
         */
        CounterStreamResponse.toObject = function toObject(message, options, q) {
            if (!options)
                options = {};
            if (q === undefined)
                q = 0;
    ...
    blerpc.CounterUploadRequest = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        CounterUploadRequest.encode = function encode(message, writer, q) {
            if (!writer)
                writer = $Writer.create();
            if (q === undefined)
                q = 0;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CounterUploadRequest.decode = function decode(reader, length, error, long) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            if (long === undefined)
                long = 0;
            if (long > $Reader.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.blerpc.CounterUploadRequest();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        CounterUploadRequest.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
         ...
         * @returns {blerpc.CounterUploadRequest} CounterUploadRequest
         */
        CounterUploadRequest.fromObject = function fromObject(object, long) {
            if (object instanceof $root.blerpc.CounterUploadRequest)
                return object;
            if (!$util.isObject(object))
                throw TypeError(".blerpc.CounterUploadRequest: object expected");
            if (long === undefined)
                long = 0;
            if (long > $util.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            let message = new $root.blerpc.CounterUploadRequest();
            if (object.seq != null)
                message.seq = object.seq >>> 0;
            if (object.value != null)
                message.value = object.value | 0;
         ...
         * @returns {Object.<string,*>} Plain object
         */
        CounterUploadRequest.toObject = function toObject(message, options, q) {
            if (!options)
                options = {};
            if (q === undefined)
                q = 0;
    ...
    blerpc.CounterUploadResponse = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        CounterUploadResponse.encode = function encode(message, writer, q) {
            if (!writer)
                writer = $Writer.create();
            if (q === undefined)
                q = 0;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        CounterUploadResponse.decode = function decode(reader, length, error, long) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            if (long === undefined)
                long = 0;
            if (long > $Reader.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.blerpc.CounterUploadResponse();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
         ...
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        CounterUploadResponse.verify = function verify(message, long) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (long === undefined)
                long = 0;
         ...
         * @returns {blerpc.CounterUploadResponse} CounterUploadResponse
         */
        CounterUploadResponse.fromObject = function fromObject(object, long) {
            if (object instanceof $root.blerpc.CounterUploadResponse)
                return object;
            if (!$util.isObject(object))
                throw TypeError(".blerpc.CounterUploadResponse: object expected");
            if (long === undefined)
                long = 0;
            if (long > $util.recursionLimit)
                throw Error("maximum nesting depth exceeded");
            let message = new $root.blerpc.CounterUploadResponse();
         ...
         * @returns {Object.<string,*>} Plain object
         */
        CounterUploadResponse.toObject = function toObject(message, options, q) {
            if (!options)
                options = {};
            if (q === undefined)
                q = 0;
